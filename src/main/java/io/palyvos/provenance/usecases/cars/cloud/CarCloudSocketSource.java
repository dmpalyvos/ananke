...
public class CarCloudSocketSource extends RichSourceFunction<CarCloudInputTuple> {
    ...
    public CarCloudSocketSource(String hostname, int port, long maxNumRetries,
    ...
    @Override
    public void run(SourceContext<CarCloudInputTuple> ctx) throws Exception {
        ...
        while (isRunning) {
            ...
            try {
                ...
                while (isRunning) {
                    ...
                    ctx.collectWithTimestamp(new CarCloudInputTuple(timestamp, receivedTuple.f1, receivedTuple.f2, receivedTuple.f3), timestamp);
                }
